...
| ClockworkPi GameShell | Full | Up to Date | The GameShell input is currently not entirely mapped. Exiting apps from "single launch mode" causes either freezing or a crash that is not fixable. Terminal UI not very useful with a controller input. |
